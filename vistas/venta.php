...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
     ...
     <select name="tipo_comprobante" onchange="llenarcomprobante(this.value)" id="tipo_comprobante" class="form-control selectpicker" required>
     <option  diasabeled  select value="select">Seleccione...</option>
